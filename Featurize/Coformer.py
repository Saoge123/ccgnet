...
class Coformer(object):
    ...
    def descriptors(self, includeSandP=True, ccdc=True, charge_model='eem2015bm'):
        if ccdc:
            return CalcuDescriptors(self.rdkit_mol, includeSandP=includeSandP, ccdc=ccdc, csd_mol=self.csd_mol, charge_model=charge_model)
        else:
            return CalcuDescriptors(self.rdkit_mol, includeSandP=includeSandP, ccdc=ccdc, csd_mol=None, charge_model=charge_model)
