...
def parameter():
    ...
    parser.add_argument('-model_path', type=str, default='./inference_model/CC_Models/', help='The path where the models are stored, default is ./snapshot/CCGNet_block/CC_Dataset/')
